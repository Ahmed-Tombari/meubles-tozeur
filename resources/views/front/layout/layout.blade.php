...
<head>
  ...
  <title>@yield('title', 'Furni - Meubles Tozeur')</title>
</head>
...
<body>
  ...
  <nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
    <div class="container">
      <a class="navbar-brand" href="{{ route('home') }}">Meubles Tozeur<span>.</span></a>
      ...
      <div class="collapse navbar-collapse" id="navbarsFurni">
        <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
          ...
          <li class="{{ request()->routeIs('services') ? 'active' : '' }}"><a class="nav-link"
  ...
  <footer class="footer-section">
    <div class="container relative">
      ...
      <div class="border-top copyright">
        <div class="row pt-4">
          <div class="col-lg-6">
            <p class="mb-2 text-center text-lg-start">Copyright &copy;{{ date('Y') }}. All Rights Reserved. &mdash;
